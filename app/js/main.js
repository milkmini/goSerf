$(function () {
  $('.header__slider').slick({
    ...
    fade: true,
    prevArrow:
      '<img class="slider-arrows slider-arrow__left" src="images/arrows-left.svg" alt=""></img>',
    nextArrow:
      '<img class="slider-arrows slider-arrow__right" src="images/arrows-right.svg" alt=""></img>',
